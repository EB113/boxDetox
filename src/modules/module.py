...
class Module(threading.Thread):
	...
	def __init__(self,opt_dict=None,save_location=None,module_name=None,profile_tag=None,profile_port=None):
		self.flag = threading.Event()
		if opt_dict == None:
			raise ValueError("Module argument opt_dict is None!")
		self.opt_dict = opt_dict
		if save_location == None:
			raise ValueError("Module argument save_location is None!")
